...
module.exports = function split (utxos, outputs, feeRate, relayFee) {
  ...
  if (remaining === 0 && unspecified === 0) return utils.finalize(utxos, outputs, feeRate, relayFee)
  ...
  return utils.finalize(utxos, outputs, feeRate, relayFee)
}
